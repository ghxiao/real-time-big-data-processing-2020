...
public class AvroReadWrite {
    public static void main(String[] args) throws IOException {
        ...
        // Serializing
        DatumWriter<ShakespeareKey> userDatumWriter = new SpecificDatumWriter<>(ShakespeareKey.class);
        ...
        DatumReader<ShakespeareKey> userDatumReader = new SpecificDatumReader<>(ShakespeareKey.class);
        DataFileReader<ShakespeareKey> dataFileReader = new DataFileReader<>(new File(file), userDatumReader);
